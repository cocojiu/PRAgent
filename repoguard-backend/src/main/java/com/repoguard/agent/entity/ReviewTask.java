...
public class ReviewTask {
    ...
    public Integer getMqRetries() { return mqRetries; }
    public void setMqRetries(Integer mqRetries) { this.mqRetries = mqRetries; }
    ...
    public LocalDateTime getNextPublishRetryAt() { return nextPublishRetryAt; }
    public void setNextPublishRetryAt(LocalDateTime nextPublishRetryAt) { this.nextPublishRetryAt = nextPublishRetryAt; }
    public String getLastPublishError() { return lastPublishError; }
    public void setLastPublishError(String lastPublishError) { this.lastPublishError = lastPublishError; }
    ...
    public LocalDateTime getReviewClaimedAt() { return reviewClaimedAt; }
    public void setReviewClaimedAt(LocalDateTime reviewClaimedAt) { this.reviewClaimedAt = reviewClaimedAt; }
    public String getReviewClaimedBy() { return reviewClaimedBy; }
    public void setReviewClaimedBy(String reviewClaimedBy) { this.reviewClaimedBy = reviewClaimedBy; }
    ...
    public void setLlmParseStatus(String llmParseStatus) { this.llmParseStatus = llmParseStatus; }
    ...
    public String getLlmPromptSummary() { return llmPromptSummary; }
    public void setLlmPromptSummary(String llmPromptSummary) { this.llmPromptSummary = llmPromptSummary; }
    public Integer getLlmPromptTokens() { return llmPromptTokens; }
    public void setLlmPromptTokens(Integer llmPromptTokens) { this.llmPromptTokens = llmPromptTokens; }
    public Integer getLlmCompletionTokens() { return llmCompletionTokens; }
    public void setLlmCompletionTokens(Integer llmCompletionTokens) { this.llmCompletionTokens = llmCompletionTokens; }
    ...
    public String getHumanReviewNote() { return humanReviewNote; }
    public void setHumanReviewNote(String humanReviewNote) { this.humanReviewNote = humanReviewNote; }
    public String getHumanReviewBy() { return humanReviewBy; }
    public void setHumanReviewBy(String humanReviewBy) { this.humanReviewBy = humanReviewBy; }
    public LocalDateTime getHumanReviewedAt() { return humanReviewedAt; }
    public void setHumanReviewedAt(LocalDateTime humanReviewedAt) { this.humanReviewedAt = humanReviewedAt; }
    public String getReviewAssignee() { return reviewAssignee; }
    public void setReviewAssignee(String reviewAssignee) { this.reviewAssignee = reviewAssignee; }
    public LocalDateTime getReviewAssignedAt() { return reviewAssignedAt; }
    public void setReviewAssignedAt(LocalDateTime reviewAssignedAt) { this.reviewAssignedAt = reviewAssignedAt; }
    public LocalDateTime getReviewSlaDeadline() { return reviewSlaDeadline; }
    public void setReviewSlaDeadline(LocalDateTime reviewSlaDeadline) { this.reviewSlaDeadline = reviewSlaDeadline; }
    public Integer getReviewEscalationLevel() { return reviewEscalationLevel; }
    public void setReviewEscalationLevel(Integer reviewEscalationLevel) { this.reviewEscalationLevel = reviewEscalationLevel; }
    public LocalDateTime getReviewLastEscalatedAt() { return reviewLastEscalatedAt; }
    public void setReviewLastEscalatedAt(LocalDateTime reviewLastEscalatedAt) { this.reviewLastEscalatedAt = reviewLastEscalatedAt; }
