...
public final class CacheNames {
    ...
    public static final String DASHBOARD_REVIEW_TREND = "dashboardReviewTrend";
    public static final String DASHBOARD_RISK_DISTRIBUTION = "dashboardRiskDistribution";
