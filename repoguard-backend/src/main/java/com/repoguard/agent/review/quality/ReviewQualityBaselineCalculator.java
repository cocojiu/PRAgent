...
/**
 * Computes the quality baseline from the normalized review read model.
 * The snapshot service controls when this expensive calculation is allowed to run.
 */
@Component
public class ReviewQualityBaselineCalculator {
    ...
    public ReviewQualityBaselineCalculator(
    ...
    public ReviewQualityBaseline calculate() {
