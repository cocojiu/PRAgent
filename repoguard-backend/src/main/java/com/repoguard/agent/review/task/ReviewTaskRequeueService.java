...
public class ReviewTaskRequeueService {
    ...
    public ReviewTaskRequeueService(
    ...
    private RequeuePublishContext prepareRequeue(Long taskId) {
        ...
        publishFailureStore.markCurrentTimelinesDone(task.getId());
        publishFailureStore.appendTimeline(task.getId(), "Message manually requeued", queuedAt, ReviewTimelineStatus.CURRENT);
    ...
    private void markPublishFailed(ReviewTask task, ReviewTaskPublishException ex, LocalDateTime failedAt) {
