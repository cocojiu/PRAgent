...
class NotificationDeliveryWorkerMetricsRecorderTest {
    ...
    private final NotificationDeliveryWorkerMetricsRecorder recorder =
        new NotificationDeliveryWorkerMetricsRecorder(recorderFactory, clock);
    ...
    void constructorRejectsMissingClock() {
        assertThatThrownBy(() -> new NotificationDeliveryWorkerMetricsRecorder(recorderFactory, null))
            .isInstanceOf(NullPointerException.class)
            .hasMessage("clock");
    }
