...
class ReviewControllerTest {
    ...
    @Test
    void listReviewsPassesOpaqueCursorParameter() throws Exception {
        mockMvc.perform(get("/api/v1/reviews")
                .param("cursor", "MjAyNi0wNy0wOFQxMjowMDoxNXwxMjM"))
            .andExpect(status().isOk());

        assertThat(lastListQuery.cursor()).isEqualTo("MjAyNi0wNy0wOFQxMjowMDoxNXwxMjM");
    }
