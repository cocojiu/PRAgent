...
public class OperationalSqlVerificationPlan {
    ...
    public List<QueryAssumption> queryAssumptions() {
        return List.of(
            new QueryAssumption(
                ...
                List.of("idx_review_finding_current_category_rule")
            ),
            new QueryAssumption(
                ReviewFindingMapper.class,
                ...
                List.of("idx_review_finding_current_category_feedback_norm")
            ),
            new QueryAssumption(
                ReviewFindingMapper.class,
                ...
                List.of("idx_review_finding_task_current_category_severity_norm")
            ),
            new QueryAssumption(
                ReviewFindingMapper.class,
                ...
                List.of(
                    "idx_review_finding_task_current_category_severity_norm",
                    "idx_changed_file_current_attempt"
                )
            ),
            new QueryAssumption(
                ReviewFindingMapper.class,
                ...
                List.of(
                    "idx_review_finding_current_category_id",
            ...
            new QueryAssumption(
                ...
                List.of("idx_changed_file_current_attempt", "idx_review_finding_current_category_file")
            ),
            new QueryAssumption(
                ChangedFileMapper.class,
    ...
    public List<IndexAlignment> indexAlignments() {
        return List.of(
            new IndexAlignment(
                "idx_review_finding_current_category_rule",
                List.of("current_attempt", "category", "rule_id"),
                "Global rule hit statistics scan only the current attempt before grouping by category and rule."
            ),
            new IndexAlignment(
                "idx_review_finding_current_category_feedback_norm",
                List.of("current_attempt", "category", "feedback_status_norm"),
                "Global feedback statistics scan only current attempts and read the generated normalized status."
            ),
            new IndexAlignment(
                "idx_review_finding_task_current_category_severity_norm",
                List.of("task_id", "current_attempt", "category", "severity_norm"),
                "Task detail severity counts enter by task_id/category before aggregating generated severity."
            ),
            new IndexAlignment(
                "idx_review_finding_current_category_id",
                List.of("task_id", "current_attempt", "category", "id"),
            ...
            new IndexAlignment(
                "idx_review_finding_current_category_file",
                List.of("task_id", "current_attempt", "category", "file_path(255)"),
                "Changed-file finding presence checks enter review_finding by task_id/category/file_path."
            ),
            new IndexAlignment(
                "idx_changed_file_current_attempt",
                List.of("task_id", "current_attempt", "id"),
                "Changed-file pages filter by task and current attempt before stable id paging."
            ),
            new IndexAlignment(
    ...
    public List<ExplainObservation> explainObservations() {
        return List.of(
            new ExplainObservation(
                ...
                List.of("key should prefer idx_review_finding_current_category_rule", "type should not degrade to ALL")
            ),
            new ExplainObservation(
                "selectReviewRuleFeedbackStat",
                List.of("idx_review_finding_current_category_feedback_norm"),
                ...
                List.of("key should prefer idx_review_finding_current_category_feedback_norm", "type should not degrade to ALL")
            ),
            new ExplainObservation(
                "selectFindingSeverityCounts",
                List.of("idx_review_finding_task_current_category_severity_norm"),
    ...
    public List<ExplainTableExpectation> explainTableExpectations() {
        return List.of(
            ...
            new ExplainTableExpectation(
                ...
                "changed_file",
                "changed",
                List.of("idx_changed_file_current_attempt"),
                List.of("ref", "range"),
            ...
            new ExplainTableExpectation(
                ...
                "review_finding",
                "finding",
                List.of("idx_review_finding_current_category_id"),
                List.of("range", "ref"),
            ...
            new ExplainTableExpectation(
                ...
                "review_finding",
                "finding",
                List.of("idx_review_finding_current_category_file"),
                List.of("ref", "eq_ref"),
