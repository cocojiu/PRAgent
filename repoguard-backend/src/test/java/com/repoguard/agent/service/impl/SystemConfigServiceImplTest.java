...
class SystemConfigServiceImplTest {
    ...
    private final SystemConfigServiceImpl service = new SystemConfigServiceImpl(integrationConfigMapper, reviewPolicyConfigMapper);
    ...
    void updateGithubIntegrationMasksTokenAndStoresNewSecret() {
        ...
        assertThat(config.getTokenValue()).isEqualTo("ghp_new_secret_1234");
    ...
    void updateReviewPolicyKeepsExistingApiKeyWhenMaskedValueIsSubmitted() {
        ...
        assertThat(config.getApiKeyValue()).isEqualTo("sk-existing-5678");
